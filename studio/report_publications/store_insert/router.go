...
type PublicationComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"publication,path=/_studio/publication-store/insert,method=POST,connector=studio,view=publication\" routeName:\"publication\" mutation:\"post\" caseFormat:\"lc\""
}
