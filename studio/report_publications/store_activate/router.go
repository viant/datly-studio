...
type PublicationComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"publication,path=/_studio/publication-store/activate,method=PATCH,connector=studio,view=publication\" routeName:\"publication\" mutation:\"patch\" caseFormat:\"lc\""
}
