...
type PublicationComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"publication,path=/_studio/publication-store/staged,method=GET,connector=studio,view=publication\" routeName:\"publication\" caseFormat:\"lc\""
}
