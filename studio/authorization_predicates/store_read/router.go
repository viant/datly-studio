...
type AuthorizationPredicateComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"authorization_predicate,path=/_studio/authorization-predicate-store,method=GET,connector=studio,view=authorization_predicate\" routeName:\"authorization_predicate\" caseFormat:\"lc\""
}
