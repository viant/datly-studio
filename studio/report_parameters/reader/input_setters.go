...
func (input *Input) SetSourceKind(value string) {
	if input == nil {
		return
	}
	input.SourceKind = value
	if input.Has == nil {
		input.Has = &InputHas{}
	}
	input.Has.SourceKind = true
}

func (input *Input) SetRequired(value bool) {
	if input == nil {
		return
	}
	...
	input.Has.Required = true
}

func (input *Input) SetEmitOutput(value bool) {
	if input == nil {
		return
	}
	input.EmitOutput = value
	if input.Has == nil {
		input.Has = &InputHas{}
	}
	input.Has.EmitOutput = true
}
