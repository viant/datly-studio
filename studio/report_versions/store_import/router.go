...
type VersionComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"version,path=/_studio/report-version-store/import,method=POST,connector=studio,view=version\" routeName:\"version\" mutation:\"post\" caseFormat:\"lc\""
}
