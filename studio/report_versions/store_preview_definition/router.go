...
type DefinitionComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"definition,path=/_studio/preview-definition,method=GET,connector=studio,view=definition\" routeName:\"definition\" caseFormat:\"lc\""
}
