...
type VersionComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"version,path=/_studio/report-version-store/touch,method=PATCH,connector=studio,view=version\" routeName:\"version\" mutation:\"patch\" caseFormat:\"lc\""
}
