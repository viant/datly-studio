...
type VersionComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"version,path=/_studio/report-version-store/edit,method=PATCH,connector=studio,view=version\" routeName:\"version\" mutation:\"patch\" caseFormat:\"lc\""
}
