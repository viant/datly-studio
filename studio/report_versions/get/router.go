...
type VersionComponent struct {
	Contract xdatly.Component[VersionGetInput, VersionGetOutput] "component:\"version,path=/v1/studio/sdk/versions.get,method=POST,connector=studio,view=version\" routeName:\"version\" mcp:\"[{\\\"kind\\\":\\\"tool\\\",\\\"name\\\":\\\"studio.sdk.versions.get\\\",\\\"description\\\":\\\"Read one authorized Datly Studio version with capability-scoped source\\\"}]\" caseFormat:\"lc\""
}
