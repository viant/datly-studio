...
type VersionComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"version,path=/_studio/report-version-store/mcp-names,method=GET,connector=studio,view=version\" routeName:\"version\" caseFormat:\"lc\""
}
