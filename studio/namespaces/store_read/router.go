...
type NamespaceComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"namespace,path=/_studio/namespace-store/read,method=GET,connector=studio,view=namespace\" routeName:\"namespace\" caseFormat:\"lc\""
}
