SELECT reports."id", reports."namespace", reports."slug", reports."title", reports."description", reports."owner_id", reports."status", reports."default_connector_name", reports."component_scope", reports."component_name", reports."current_draft_version", reports."etag", reports."created_at", reports."updated_at" FROM  (
