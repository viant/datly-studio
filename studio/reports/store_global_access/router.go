...
type ReportComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"report,path=/_studio/report-store/global-access,method=GET,connector=studio,view=report\" routeName:\"report\" caseFormat:\"lc\""
}
