...
type ReportComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"report,path=/v1/studio/reports,method=PATCH,connector=studio,view=report\" routeName:\"report\" mutation:\"patch\" caseFormat:\"lc\""
}
