...
func (entity *StoredReport) GetCurrentDraftVersion() *int {
	return entity.CurrentDraftVersion
}
func (entity *StoredReport) SetCurrentDraftVersion(value *int) {
...
func (entity *StoredReport) GetDeletedAt() *time.Time {
	return entity.DeletedAt
}
func (entity *StoredReport) SetDeletedAt(value *time.Time) {
