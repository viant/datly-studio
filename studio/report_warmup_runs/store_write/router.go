...
type WarmupRunComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"warmup_run,path=/_studio/report-warmup-run-store/write,method=PATCH,connector=studio,view=warmup_run\" routeName:\"warmup_run\" mutation:\"patch\" caseFormat:\"lc\""
}
