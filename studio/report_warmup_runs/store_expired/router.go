...
type WarmupRunComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"warmup_run,path=/_studio/report-warmup-run-store/expired,method=GET,connector=studio,view=warmup_run\" routeName:\"warmup_run\" caseFormat:\"lc\""
}
