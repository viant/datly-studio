...
type FolderComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"folder,path=/v1/studio/report-resource-folders,method=PATCH,connector=studio,view=folder\" routeName:\"folder\" mutation:\"patch\" caseFormat:\"lc\""
}
