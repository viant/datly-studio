...
type UsageComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"usage,path=/_studio/resource-namespace-store/presence,method=GET,connector=studio,view=usage\" routeName:\"usage\" caseFormat:\"lc\""
}
