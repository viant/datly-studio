...
type ConnectorComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"connector,path=/_studio/preview-connectors/scoped,method=GET,connector=studio,view=connector\" routeName:\"connector\" caseFormat:\"lc\""
}
