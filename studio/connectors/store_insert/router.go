...
type ConnectorComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"connector,path=/_studio/connector-store/insert,method=POST,connector=studio,view=connector\" routeName:\"connector\" mutation:\"post\" caseFormat:\"lc\""
}
