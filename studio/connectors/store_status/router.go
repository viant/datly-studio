...
type ConnectorComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"connector,path=/_studio/connector-store/status,method=PATCH,connector=studio,view=connector\" routeName:\"connector\" mutation:\"patch\" caseFormat:\"lc\""
}
