...
type UsageComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"usage,path=/_studio/connector-store/usage,method=GET,connector=studio,view=usage\" routeName:\"usage\" caseFormat:\"lc\""
}
