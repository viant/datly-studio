...
type ConnectorComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"connector,path=/_studio/connector-store/catalog,method=GET,connector=studio,view=connector\" routeName:\"connector\" caseFormat:\"lc\""
}
