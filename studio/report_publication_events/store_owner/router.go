...
type ReportComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"report,path=/_studio/publication-event-store/owner,method=GET,connector=studio,view=report\" routeName:\"report\" caseFormat:\"lc\""
}
