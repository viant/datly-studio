...
type SessionComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"session,path=/v1/studio/sessions,method=PATCH,connector=studio,view=session\" routeName:\"session\" mutation:\"patch\" caseFormat:\"lc\""
}
