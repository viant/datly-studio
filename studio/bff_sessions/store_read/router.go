...
type SessionComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"session,path=/_studio/bff-session-store,method=GET,connector=studio,view=session\" routeName:\"session\" caseFormat:\"lc\""
}
