...
type SessionComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"session,path=/_studio/bff-session-store,method=PATCH,connector=studio,view=session\" routeName:\"session\" mutation:\"patch\" caseFormat:\"lc\""
}
