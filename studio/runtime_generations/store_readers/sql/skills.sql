SELECT skill."report_id", skill."version_no", skill."skill_id", skill."skill_root", skill."uri_prefix" FROM (SELECT s.report_id, s.version_no, s.skill_id, s.skill_root, f.uri_prefix
