...
type GenerationComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"generation,path=/_studio/runtime-generation-store/insert,method=POST,connector=studio,view=generation\" routeName:\"generation\" mutation:\"post\" caseFormat:\"lc\""
}
