...
type HeadComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"head,path=/_studio/runtime-generation-store/head,method=GET,connector=studio,view=head\" routeName:\"head\" caseFormat:\"lc\""
}
