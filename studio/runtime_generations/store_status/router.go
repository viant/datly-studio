...
type GenerationComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"generation,path=/_studio/runtime-generation-store/status,method=GET,connector=studio,view=generation\" routeName:\"generation\" caseFormat:\"lc\""
}
