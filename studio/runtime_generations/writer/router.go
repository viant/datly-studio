...
type GenerationComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"generation,path=/v1/studio/runtime-generations,method=PATCH,connector=studio,view=generation\" routeName:\"generation\" mutation:\"patch\" caseFormat:\"lc\""
}
