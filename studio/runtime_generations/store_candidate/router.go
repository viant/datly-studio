...
type DefinitionComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"definition,path=/_studio/runtime-definitions/candidate,method=GET,connector=studio,view=definition\" routeName:\"definition\" caseFormat:\"lc\""
}
