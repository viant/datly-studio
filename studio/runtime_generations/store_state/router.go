...
type GenerationComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"generation,path=/_studio/runtime-generation-store/state,method=PATCH,connector=studio,view=generation\" routeName:\"generation\" mutation:\"patch\" caseFormat:\"lc\""
}
