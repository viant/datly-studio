...
type AclComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"acl,path=/_studio/report-acl-store/one,method=GET,connector=studio,view=acl\" routeName:\"acl\" caseFormat:\"lc\""
}
