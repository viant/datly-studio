...
type AclComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"acl,path=/v1/studio/reports/{reportId}/acl,method=GET,connector=studio,view=acl\" routeName:\"acl\" mcp:\"[{\\\"kind\\\":\\\"tool\\\",\\\"name\\\":\\\"studio.report_acl.read\\\",\\\"description\\\":\\\"Read report access policy\\\"}]\" caseFormat:\"lc\""
}
