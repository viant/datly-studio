...
type FileComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"file,path=/_studio/skill-validation/content,method=GET,connector=studio,view=file\" routeName:\"file\" caseFormat:\"lc\""
}
