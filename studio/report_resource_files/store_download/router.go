...
type FileComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"file,path=/_studio/report-resource-files-store/download,method=GET,connector=studio,view=file\" routeName:\"file\" caseFormat:\"lc\""
}
