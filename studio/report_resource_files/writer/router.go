...
type FileComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"file,path=/v1/studio/report-resource-files,method=PATCH,connector=studio,view=file\" routeName:\"file\" mutation:\"patch\" caseFormat:\"lc\""
}
