...
type SkillComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"skill,path=/v1/studio/report-skill-roots,method=PATCH,connector=studio,view=skill\" routeName:\"skill\" mutation:\"patch\" caseFormat:\"lc\""
}
