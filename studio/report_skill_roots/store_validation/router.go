...
type SkillComponent struct {
	Contract xdatly.Component[Input, Output] "component:\"skill,path=/_studio/skill-validation/roots,method=GET,connector=studio,view=skill\" routeName:\"skill\" caseFormat:\"lc\""
}
